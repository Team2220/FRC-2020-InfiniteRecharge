...
public class Robot extends TimedRobot {
  ...
  public void testInit() {
    ...
    // leftFalcon.setInverted(TalonFXInvertType.CounterClockwise);
    // rightFalcon.setInverted(TalonFXInvertType.Clockwise);
  }

  // TalonFX leftFalcon = new TalonFX(1);
  // TalonFX rightFalcon = new TalonFX(2);
